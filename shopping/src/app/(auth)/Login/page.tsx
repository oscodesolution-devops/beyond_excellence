                    ...
                    xl:text-bold">Log in</h2>
                        <div className="mt-12">
                            <form>
                                ...
                                <div className="mt-8">
                                    ...
                                    <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                        ...
                                        type="password"
                                        value={user.password}
                                        onChange={(e) => setUser({ ...user, password: e.target.value })} placeholder="Enter your password" />
                                </div>
                                <div className="mt-10">
                                    <button onClick={onLogin} className="bg-theme text-gray-100 p-4 w-full rounded-full tracking-wide
                            ...
                            <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                                Dont have an account ? <Link href={"/Signin"} className="cursor-pointer text-indigo-600 hover:text-indigo-800">Sign up</Link>
                            </div>
                        </div>
                    </div>
                </div>
