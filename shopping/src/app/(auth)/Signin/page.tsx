...
export default function SignupPage() {
    ...
    useEffect(() => {
        ...
        if (user.email.length > 0 && user.password.length > 0 && user.name.length > 0 && user.number.length >= 10) {
    ...
    return (
        <>
            <div className="lg:flex bg-theme-900">
                <div className="lg:w-1/2 xl:max-w-screen-sm">

                    <div className="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl ">
                        <h2 className="text-center text-4xl text-indigo-900 font-display font-semibold lg:text-left xl:text-5xl
                    xl:text-bold">{loading ? "Processing" : "Sign In"}</h2>
                        <div className="mt-12">
                            <form>
                                <div>
                                ...
                                <div className='mt-6'>
                                    <div className="text-sm font-bold text-gray-700 tracking-wide">Mobile no.</div>
                                    <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500"
                                        id="number"
                                        type="text"
                                        value={user.number}
                                ...
                                <div className="mt-10">
                                    <button onClick={onSignup} className="bg-theme text-gray-100 p-4 w-full rounded-full tracking-wide
                            ...
                            <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                                I have an account ? <Link href={"/Login"} className="cursor-pointer text-indigo-600 hover:text-indigo-800">Login</Link>
                            </div>
                        </div>
                    </div>
                </div>
