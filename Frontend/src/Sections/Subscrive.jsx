...
const Subscrive = () => {
  ...
  return (
    ...
    <div className={`w-[100%] xl:mt-0 -mt-4 -ml-10 md:px-[50px] md:w-[50%] xl:w-[50%] px-0 xl:px-[70px] ${leftImage?`xl:ml-0`:`xl:ml-[100px]`} ${leftImage?`md:ml-0`:`md:ml-[100px]`}`}>
        ...
        <div className="flex justify-between mb-3 -ml-4 w-[500px] md:w-[400px] h-[50px]">
            ...
            <button className="shadow-lg bg-theme-200 text-white font-bold text-sm rounded px-4 w-[250px] py-2">Subscribe Now</button>
        </div>
</div>

    </div>
    <div className="xl:w-[40%] md:w-[40%]  xl:mb-0 -mb-10">
